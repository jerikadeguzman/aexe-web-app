                ...
                <DrawerContent>
                  ...
                  <Flex flexDir="column" align="center">
                      <NextLink href="/Announcement" passHref>
                        <Button as="a" variant="ghost" aria-label="Announcemnt" my={5} w="100%" textColor='#DAE3F3'>Announcement</Button>
                      </NextLink>
                  </Flex>
              ...
              <Box bg="lavender" w="1550px" h="800px" >
                  <Center>
                    <Box bg="#8FAADC" w="800px" h="800px"
                      ...
                      <HStack spacing='550px' justifyContent="center">
                        <Text textAlign='left' padding={15} fontSize='20' fontWeight='bold'>Messages</Text>
                        <IconButton aria-label='Search Message' icon={<Search2Icon />}/>
