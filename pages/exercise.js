                  ...
                  <DrawerBody bgColor='#8FAADC'>
                    <Flex flexDir="column" align="center">
                      <NextLink href="/Messages" passHref>
                        <Button as="a" variant="ghost" aria-label="Meesages" my={5} w="100%" textColor='#DAE3F3' color="blue">Messages</Button>
                      </NextLink>
                  </Flex>
              ...
              <Box bg="lavender" w="1550px" h="1000px" >
                  <Center>
                    <Box bg="#8FAADC" w="900px" h="1000px"
                          ...
                          boxShadow="md">
                       <Text textAlign='center' padding='5' fontSize='20' fontWeight='bold'>Exercises</Text>
